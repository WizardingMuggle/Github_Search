...
import Spinny from '../Components/layout/Spinny'
import { Link } from 'react-router-dom'
import UserRepos from '../Components/users/UserRepos'

function User() {

  const {person, loading, repos, getRepos} = useContext(GithubContext)

  useEffect(() => {
    getRepos(person.login);
  },);
  ...
  return (
    <div className="w-full mx-auto lg:w-10/12">
      ...
      <div className="w-full py-5 mb-6 rounded-lg shadow-md bg-basr-100 stats">
        <div className="stat">
